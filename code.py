...
'''
using the equation Pi = fi\'N
N = Total number of combinations of 2 dice
Fi = frequency of the sum i occuring
Pi = probably of the sum i occuring
 '''
...
Factorization of Si
Fi = factorint(Si)
Distribute the prime factors Fi on the new dice making sure each die spots sum to 36

Pi = Original probability of the sum i
C = common denominator (36)
Si = total spots required for the sum i
Fi = prime factors of Si
Di = distribution of the spots for the sum i on each die
'''
